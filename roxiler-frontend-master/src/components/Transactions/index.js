...
const Transactions = () => {
    ...
    useEffect(()=>{
        const getTransactions = async ()=>{
            const list = await axios.get(`https://roxiler-backend-vijaykumars-projects.vercel.app/bar-chart?month=${selectedMonth}&page=${page}&search=${searchInput}&perPage=10`)
